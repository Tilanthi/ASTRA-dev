% ASTRA RASTI Paper V1.49 — 2026-06-17
% V1.49: xu2026magmarw33a (arXiv:2606.16915) added to §9.5 Physical Interpretation.
%   MagMaR VII: ALMA 1.2 mm full-polarization observations of W33 A resolve 20 dense cores
%   and 9 filaments; coherent trans-Alfvenic B-fields along the main filaments; magnetic
%   support required to suppress F-Main radial collapse/fragmentation; A&A accepted.
% V1.48: bom2026lsstdecision (arXiv:2606.05285) added to §10.2 Autonomous Analysis Agents.
%   Bom, Mahabal, Bianco et al. (Rubin LSST TVS SC): perspective article proposing
%   decision-theoretic agentic AI for LSST time-domain astronomy; foundation models +
%   human-supervised agentic systems for follow-up allocation under uncertainty;
%   complements ASTRA's downstream analysis with upstream survey-operations framing.
% V1.47: lucente2026darkagents (arXiv:2606.11157) added to §10.2 Narrower Astrophysics Frameworks.
%   DarkAgents: multi-agent system for theoretical astroparticle physics (Lucente, Pascoli, Sala, Zandi);
%   LLM reasoning + deterministic code for cosmological phase transitions + NANOGrav GW spectra;
%   assumption/prior audit reports; found literature fit inconsistencies; open source.
%
% V1.46: ristorcelli2026filbfield (arXiv:2606.04713) added to §9.5 Physical Interpretation.
%   Ristorcelli, Ferrière, Juvela, Montier, Alina, Montillaud (Toulouse/Helsinki/Nazarbayev/Besançon):
%   Statistical filament-B-field orientations across 116 Herschel GCC fields + Planck polarimetry;
%   low-NH2 parallel, high-NH2 perpendicular, transition at (0.8–8)×10^21 cm^-2;
%   validates ASTRA Campaign F finding that perpendicular-B filaments fragment 2.1–2.9× faster.
% V1.45: wang2026multiscale (arXiv:2605.30489) added to §9.5 Physical Interpretation.
%   Multi-scale B-field observations (JCMT+ACA+ALMA, ~5 pc to ~4000 au) in hub-filament system;
%   U-shaped B-field structures aligned with accreting filaments; B-field scaling index κ=0.50±0.10;
%   colliding flows drag magnetic fields and trigger star formation; validates TC7 physical regime.
% V1.44: nguyen2026physicsallyouneed (arXiv:2605.30353) added to §10.2 empirical evaluations paragraph.
%   Quantified case study: physicist-supervised AI coding agent (CLAX-PT); 33/57 sessions optimising
%   wrong architecture; fudge factor passed all oracle tests; ICML 2026 AI for Science Workshop.
% V1.43: inguglia2026etagents (arXiv:2605.28916) added to §10.2 empirical evaluations paragraph.
%   First head-to-head comparison of agentic AI (Claude Code vs Codex) on Einstein Telescope GW
%   pipeline: silent instruction reinterpretation → genuine scientific divergence; speed-auditability
%   tradeoff. bib: 75 → 76 entries.
% ASTRA RASTI Paper V1.42 — 2026-05-20
% V1.42: islam2026gwagent (arXiv:2605.11280) added to §10.2 Narrower Astrophysics Frameworks paragraph.
%   GWAgent: LLM-based agentic workflow for interpretable analytic GW surrogates (Islam, Wadekar et al.);
%   validation-constrained against ground-truth sims; physics-informed ansatz; eccentric BBH mergers.
%   bib: 74 → 75 entries.
% ASTRA RASTI Paper V1.41 — 2026-05-17
% V1.41: bisht2026notbuilt (arXiv:2605.08956) + faroughy2026colliderbench (arXiv:2605.13950)
%   added to §10.2 empirical evaluations paragraph. Bisht: 4 fundamental design challenges for
%   AI scientists, recommends simulations as verifiers (aligns with ASTRA TC7 approach).
%   Faroughy: Collider-Bench — no agent beats physicist-in-the-loop in LHC analysis reproduction.
%   bib: 72 → 74 entries.
% ASTRA RASTI Paper V1.40 — 2026-05-16
% V1.40: xu2026cosmoevolve (arXiv:2605.14791) added to §10.2 Autonomous Analysis Agents paragraph.
%   CMBEvolve (code evolution + tree search) + CosmoEvolve (virtual multi-agent lab); cosmology-specific;
%   Xu & Borrett (Cambridge); Moriond 2026 contribution. bib: 71 → 72 entries.
% ASTRA RASTI Paper V1.39 — 2026-05-15
% V1.39: P0 caputo2026nasa title+footnote fix; P1 pandya2026sapphire fix; P2 mitchener2025kosmos bib format.
% ASTRA RASTI Paper V1.38 — 2026-05-14
% V1.38: somasekharan2026cfdscientist (arXiv:2605.06607) added to §10.2 Narrower Astrophysics Frameworks paragraph.
%   AI CFD Scientist (Somasekharan, Pathak, Dhanakoti, Zhang, Yue, Zhu, Pan; RPI): physics-aware AI scientist
%   for CFD with vision-language physics-verification gate; planted-failure ablation shows 14/16 silent
%   failures caught by domain gate (missed by solver checks). Contrasts ASTRA: CFD-only vs. 7 regimes.
%   bib: 70 → 71 entries.
% ASTRA RASTI Paper V1.37 — 2026-05-13
% V1.37: lin2026reconstructability (arXiv:2605.11154) added to §10.2 empirical evaluations paragraph.
%   Lin (U Michigan, PASP submission): information-theoretic framework (Shannon entropy, JS divergence)
%   quantifies LLM failure to reconstruct astrophysical methods; irreducible entropy floor of
%   implementation variance even with full Methods sections; tacit expert knowledge not recoverable.
%   Directly motivates ASTRA physics validation layer. bib: 69 → 70 entries.
% ASTRA RASTI Paper V1.36 — 2026-05-12
% V1.36: dong2026gweyes (arXiv:2605.10584) added to §10.2 Narrower Astrophysics Frameworks paragraph.
%   GW-Eyes: LLM-powered agentic framework for GW multi-messenger counterpart association (Dong et al. 2026).
%   Contrasts ASTRA: single-task (GW counterpart matching) vs. 7 regimes; no physics validation/causal discovery. bib: 68 → 69 entries.
% ASTRA RASTI Paper V1.35 — 2026-05-10
% V1.35: simulation count clarification (900+320 in TC7 intro); isothermal count 552→522; zhang2026fldf author fix.
% ASTRA RASTI Paper V1.34 — 2026-05-10
% V1.34: feng2026lensagent (arXiv:2604.03691) added to §10.2 Narrower Astrophysics Frameworks paragraph.
%   LensAgent: training-free LLM-driven autonomous mass-distribution inference in SLACS strong lensing systems.
%   Contrasts ASTRA: single-domain vs. 7 regimes; no physics validation layer. bib: 67 → 68 entries.
% ASTRA RASTI Paper V1.33 — 2026-05-09
% V1.33: NASA ASTRA footnote (caputo2026nasa); P1 style fixes (keywords sep, Acknowledgements, cite→citep/citet, manual et al.)
%
% ASTRA RASTI Paper V1.32 — 2026-05-08
% Changes from V1.31:
%   - TC7 Physical Interpretation: Added hirano2026popiii (arXiv:2602.20690)
%     Hirano, Sakai, Umeda (Kanagawa/Tokyo): 138 cosmological zoom-in simulations show Pop III IMF
%     varies with halo mass, redshift, and baryon-DM streaming velocity; rules out universal Pop III IMF.
%     Placed between rosen2026 (binary bias) and cohen2026smc (SMC JWST counterpoint) to strengthen
%     the evidence that environment-dependent fragmentation operates across cosmic history.
%   - bib: 65 → 66 entries
% ASTRA RASTI Paper V1.31 — 2026-05-07
% Changes from V1.30:
%   - §10.2 Narrower Astrophysics Frameworks paragraph: Added wang2026climagent (arXiv:2604.16922)
%     Wang, Han, Fan, Liu (HKUST/Shandong/Auckland): ClimAgent — autonomous LLM-based framework
%     for climate science analysis; ClimaBench benchmark; 40.21% improvement over base LLM solutions.
%     Demonstrates domain-specific AI scientists outperform general-purpose LLMs in physical sciences.
%     Analogous to ASTRA's domain-specific approach but in climate science; lacks physics validation.
%   - bib: 64 → 65 entries
% ASTRA RASTI Paper V1.30 — 2026-05-06
% Changes from V1.29:
%   - §10.2 Domain-Agnostic AI Scientists paragraph: Added alexander2026albert (arXiv:2603.28935)
%     Alexander, Bradley, Gouskos, Niu (Brown Univ.): ALBERT neuro-symbolic framework for particle
%     physics theory discovery via formal grammar; hallucination-free by construction; rediscovered
%     Standard Model + top-quark mass 178.9±5.0 GeV from legacy LEP data alone. Provides contrast
%     to ASTRA's validation-layer approach: construction-time constraints vs. analysis-step enforcement
%   - bib: 63 → 64 entries
% ASTRA RASTI Paper V1.29 — 2026-05-05
% Changes from V1.28:
%   - Discussion §10.1 (TC7 paragraph): Added Campaign F power-law scalings
%     (t_frag ∝ f^{-0.537}β^{-0.160} longitudinal; t_frag ∝ f^{-0.865}β^{-0.126} perpendicular;
%     2.1–2.9× geometry speedup) and Campaign G λ/W_⊥=1.631±0.034 (universal, √3 Jeans limit)
%   - Conclusion §11 (Test 7 bullets): Added 2 new bullets for Campaign F and Campaign G;
%     W3 cross-validation note added (0.163 vs 0.171 pc, 4.7% agreement)
%   - These results were in the abstract (V1.26) but absent from Discussion and Conclusion
% ASTRA RASTI Paper V1.28 — 2026-05-04
% Changes from V1.27:
%   - New citation (1): borrett2026cmbagent (arXiv:2604.09621) — "Competing with AI Scientists"
%     Borrett+2026: Cmbagent fully autonomous mode failed expert level; human intervention
%     achieved first place in FAIR Universe Weak Lensing Challenge — confirms human-AI
%     collaboration necessity; added to §10.2 empirical evaluations paragraph
%   - bib: 62 → 63 entries
% ASTRA RASTI Paper V1.27 — 2026-05-03
% Changes from V1.26:
%   - New citations (5): bisht2026mlcores, chopra2026llmscientists, cohen2026smc,
%                        yamada2025aiscientistv2, ye2025replicationbench
%   - TC7 Physical Interpretation: Added Cohen+2026 (JWST SMC IMF to 0.16 M☉; α2=-2.17±0.11
%     consistent with solar neighbourhood — supports IMF universality at low metallicity)
%   - TC7 Physical Interpretation: Added Bisht+2026 (XGBoost on 2.1M MHD tracer particles;
%     R²>0.99 core prediction — complementary ML perspective on core formation)
%   - §10.2 Related Work: Added yamada2025aiscientistv2 (AI Scientist-v2 first AI paper to
%     pass ICLR workshop peer review) to domain-agnostic AI Scientists paragraph
%   - §10.2 Related Work: Added ye2025replicationbench (ReplicationBench <20% AI replication
%     of astro papers) + chopra2026llmscientists (6 LLM failure modes in AI science) to
%     empirical evaluations paragraph; strengthens ASTRA physics-validation motivation
%   - bib: 57 → 62 entries
% ASTRA RASTI Paper V1.26 — 2026-05-02
% Changes from V1.25:
%   - Campaign F (Theoretician Parameter Survey, 149 sims) added to §9.2:
%       STV (75 sims, θ=0°, f×β grid) + PFS (60 sims, θ=90°) + NCRI (14 sims, f→1.0)
%   - Campaign G (λ/W Direct Measurement, 66 sims) added to §9.2:
%       DOMAIN_TEST (3) + LW_DIRECT (36, θ=0°) + PERP_TIMESERIES (27, θ=90°)
%   - §9.3: 2D power-law fits for t_frag(f,β): eqs (tfrag_para) and (tfrag_perp)
%   - §9.3: λ/W direct measurement: λ/W_perp=1.631±0.034 (universal); λ/W_para=7.02±3.07
%   - §9.4: Near-critical strengthened with NCRI f=1.0→1.623 t_J smooth monotonic result
%   - §9.5: λ/W cross-validation for W3 prediction (0.163 vs 0.171 pc, 4.7% agreement)
%   - Simulation count updated: "over 1,000" → "over 1,200" throughout
%   - Campaign count: five → seven throughout
%   - TC7 closing paragraph updated to describe 7-campaign progressive structure
% ASTRA RASTI Paper V1.25 — 2026-05-01
% Changes from V1.24:
%   - P0 bib fix: cranmer2024ltu → ho2024ltuili (wrong first author Matthew Ho, wrong title
%                 "LtU-ILI...", wrong DOI 10.21105/astro.2402.05137 → 10.33232/001c.120559)
%   - P0 bib fix: kumar2025w3bfield DOI corrected (202453027→202554901; was resolving to
%                 black hole paper); title updated to actual published title (A&A 703, A74)
%   - P1 bib fix: wang2025starwhisper first author corrected (Y. Wang→C. Wang/Cunshi Wang);
%                 title corrected to actual published title (Commun. Eng. 4, 184)
%   - P1 bib fix: garciamoreno2026 title corrected to actual A&A 706, A377 title
%   - P2 bib fix: mucesh2024 journal field corrected (was MNRAS, paper still under review)
%   - New citations: villaescusanavarro2025denario (Denario project), rawat2026plausible
%                   (CMBAgent silent physics failures), baker2026spectroxide (physics bugs
%                   evade automated testing); added to §10.2 Related Work
%   - \cite{cranmer2024ltu} → \cite{ho2024ltuili} in §10.2
%   - bib: 54 → 57 entries
% Changes from V1.22:
%   - P1 fix: Removed Π_meas = 1.012 "Dimensional Analysis Comparison" paragraph from §3
%             (persistent inconsistency: Π_meas cannot be derived from A_meas = 0.0812 via
%             standard definition; Jensen's inequality explanation was correct but confusing)
%   - P1 fix: Simplified §7.3 Theoretical Validation — removed Π_measured/Π_theory = 0.72
%             cross-reference; amplitude ratio A_meas/A_theory = 0.88 is consistent alone
%   - P1 citations: Added tritsis2025m2f (Zeeman M2F upper limits) + whitworth2026bn
%                   (B-n broken power law) to §9.5 Physical Interpretation
%   - P1 citation: Added pandya2026sapphire (sapphire JAX galaxy framework) to §10.2 Related Work
%   - bib: +4 new entries (crutcher2010, tritsis2025m2f, whitworth2026bn, pandya2026sapphire);
%          total 54 entries
% Changes from V1.21:
%   - V1.22: P0 bib fix panopoulou2022 (wrong authors/title/DOI), sutherland1992 (wrong title)
%   - V1.22: steinhardt2026 + rosen2026 added to TC7 Physical Interpretation
% Changes from V1.19:
%   - Fix P1-1: Geometric factor √(1/2) explanation replaced with correct Jensen/estimator-mismatch explanation (§3 and §7.3 now consistent)
%   - Fix P1-2: Bootstrap notation clarified — ±0.0043 is 1σ standard error; 95% CI stated explicitly
%   - Fix P1-3: TC3 — added correlation statistics for the two strongest relationships; notebook reference for full table
%   - Fix P1-4: TC4 — added Fisher Z-test p-values and multiple comparison note
%   - Fix P2-3: TC6 conclusion grammar (below-MS subcategories grammar fixed)
%   - Fix P2-4: p < 10^{-300} noted as machine precision limit in TC6
%   - New citations: mitchener2025kosmos (Kosmos), agrawal2026flare (FLARE), zhang2026fldf (FLDF=Salpeter), suin2025feedback (MHD B-field override), andre2026jwst (JWST width confirmation)
%   - Related Work: Added Kosmos + FLARE competitor citations
%   - TC1: Added André+2026 JWST width confirmation + Zhang+2026 FLDF→IMF context
%   - TC7: Added Suin+2025 MHD feedback B-field override citation
% Changes from V1.18:
%   - Added Campaign E (314-sim PR response) to §9.2 Simulation Setup
%   - Added adiabatic EOS suppression result (Phase 4) to §9.3 Results
%   - Updated near-crit perp-B comparison (near-crit f vs supercrit f reversal) in §9.4
%   - Updated "over 700" → "over 1,000" simulations throughout (abstract, §9.1, §9.2, §10, §11)
%   - Added new Figure (test07_adiabatic_comparison.pdf) — isothermal vs adiabatic
%   - Added new Figure (test07_oblique_calibration.pdf) — Phase 3 oblique angle calibration
% Changes from V1.17 (V1.18):
%   Added §9.4 Robustness and Field Geometry Validation (89 PR robustness sims),
%   Figs 15–16 (angle dependence, near-crit t_frag), nagasawa1987+tomisaka2014 refs.
...
The seventh test case demonstrates autonomous HPC simulation campaign management: ASTRA co-ordinated over 1,200 Athena++ MHD simulations on a remote 224-vCPU server across seven interlinked campaigns to validate the magnetic Jeans fragmentation criterion for ISM filaments, confirming the predicted stability threshold $\beta_\mathrm{crit} = 2/3$, calibrating the fragmentation wavelength to $(1.11 \pm 0.12)\,\lambda_{J,m}(\theta,\beta)$ across 18 field-geometry configurations, establishing 2D power-law scalings for fragmentation timescale ($t_\mathrm{frag} \propto f^{-0.54}\beta^{-0.16}$ for longitudinal fields; $t_\mathrm{frag} \propto f^{-0.86}\beta^{-0.13}$ for perpendicular fields), measuring the fragmentation wavelength-to-width ratio $\lambda/W = 1.631 \pm 0.034$ (universal for perpendicular-field filaments), and demonstrating that an adiabatic equation of state completely suppresses near-critical fragmentation, validating the isothermal assumption as the conservative lower bound.
...
ASTRA\footnote{Note: NASA's Astrophysics Strategic Technology \& Research Accelerator (ASTRA) initiative shares this acronym \citep[see][]{caputo2026nasa}. The present paper describes a distinct AI-driven autonomous research system for astrophysical data analysis.} addresses this challenge by providing an integrated framework that combines:
\begin{description}
...
We analyzed 24 molecular cloud filaments from the Herschel Gould Belt Survey (HGBS) \citep{andre2010}, drawn from the publicly released filament catalogue \citep{arzoumanian2019}. Each filament has measurements of mass $M$, length $L$, and velocity dispersion $\sigma_v$ with distance estimates based on nearby Galactic OB associations. We note that the universal width of $\sim$0.1~pc in Herschel filaments has been extensively debated, with \citet{panopoulou2022} arguing that apparent universality may partly reflect observational selection effects.
...
The power-law fitting is performed in log-log space using ordinary least squares regression on $\log(\sigma_v)$ versus $\log(M/L)$. The reported uncertainty $\pm 0.0043$ is the bootstrap standard error (1$\sigma$), derived from non-parametric bootstrap resampling of the 24 data points (10,000 resamples), where each resample draws 24 filaments with replacement and refits the power law. The 95 per\,cent confidence interval computed from the 2.5th and 97.5th percentiles of the bootstrap distribution is $[0.0726, 0.0898]$~km\,s$^{-1}$\,(M$_\odot$\,pc$^{-1}$)$^{-0.5}$.
...
\begin{figure*}
\centering
\includegraphics[width=0.9\textwidth]{figures/test02_scaling_relations.pdf}
...
\textbf{Universal Width}: Filaments have a characteristic width of $0.098 \pm 0.019$~pc, independent of mass \citep[confirmed at 1.3~kpc resolution with JWST by][]{andre2026jwst}. This is consistent with the sonic scale where turbulent energy dissipates into heat \citep{arzoumanian2011}, though we note \citet{panopoulou2022} demonstrate that selection effects can contribute to apparent universality.
...
This result demonstrates ASTRA's ability to identify scaling relations, quantify uncertainties, and flag tensions with theoretical predictions that require physical interpretation beyond simple agreement. The filament scaling relations recovered here are directly relevant to the origin of the stellar initial mass function: \citet{zhang2026fldf} demonstrate that the filament linear density function follows a power law with slope $\alpha \approx 1.30$--$1.34$ across seven molecular clouds, statistically indistinguishable from the Salpeter IMF slope of 1.35, providing the strongest direct observational evidence that the stellar mass spectrum is pre-encoded in large-scale filamentary structure.

\section{Test Case 2: Multi-Wavelength Data Fusion}

\subsection{Data and Methods}

We analyzed the Chandra Deep Field South (CDFS) \citep{giacconi2001}, combining data from X-ray (Chandra ACIS, 0.1--10~keV), optical (HST/ACS F775W filter), and near-infrared (VLT/ISAAC Ks-band). The X-ray catalog contains $\sim$370 sources from the 1~Msec exposure \citep{alexander2003}, of which we analyze the 60 sources with secure detections in all three wavebands.

\textbf{Cross-Matching Methodology}: We use Bayesian positional cross-matching following \citep{sutherland1992}. For each X-ray source with positional uncertainty $\sigma_{\mathrm{X}}$, we compute the likelihood of association with each optical/IR source given the positional offset $\theta$ and their combined positional uncertainties $\sigma_{\mathrm{tot}} = \sqrt{\sigma_{\mathrm{X}}^2 + \sigma_{\mathrm{O}}^2}$. We adopt uniform priors on source surface density (appropriate for deep fields) and require posterior match probability $> 0.9$. The cross-matching radius is adaptively set to $3\sigma_{\mathrm{tot}}$ with a maximum of 2 arcsec to account for source density variations.
...
\textbf{Classification Methodology}: Following standard X-ray source classification \citep{hornschemeier2001,bauer2004}, we classify sources using X-ray hardness ratio HR $= (H-S)/(H+S)$ where H and S are hard and soft band counts, and X-ray-to-optical flux ratio $f_{\mathrm{X}}/f_{\mathrm{opt}}$. We adopt the thresholds: AGN if HR $> -0.2$ and $\log(f_{\mathrm{X}}/f_{\mathrm{opt}}) > -1$, stars if HR $< -0.2$ or $\log(f_{\mathrm{X}}/f_{\mathrm{opt}}) < -1$. Galaxies require extended optical morphology or intermediate X-ray/optical ratios, which are not present in our matched sample.

\subsection{Results}

\begin{figure*}
\centering
\includegraphics[width=0.9\textwidth]{figures/test04_multiwavelength_fusion.pdf}
...
We analyzed 600 galaxies drawn from the Sloan Digital Sky Survey (SDSS) Data Release 7 \citep{abazajian2009}, selected to have complete measurements of stellar mass, star formation rate, gas-phase metallicity, and local galaxy density. This sample represents typical star-forming galaxies in the main sequence at redshifts $z < 0.2$. The star formation rates and gas-phase metallicities are taken from the MPA-JHU value-added catalogue \citep{brinchmann2004}, which provides these derived quantities using standard emission-line analysis for SDSS spectra.
...
\begin{figure*}
\centering
\includegraphics[width=0.9\textwidth]{figures/test5_hypothesis_generation.pdf}
...
\begin{enumerate}
\item \textbf{Mass-metallicity relation}: Stellar mass correlates with gas-phase metallicity, reflecting the well-established mass-metallicity relation \citep{tremonti2004}.
   \begin{description}
...
\item \textbf{Environmental quenching}: Local galaxy density correlates with star formation rate, consistent with environmental quenching \citep{dressler1980,peng2010}.
   \begin{description}
...
\item \textbf{Merger rate evolution}: Galaxy merger signatures correlate with redshift within the sample range.
   ...
   \item Literature: Merger rate evolution is well-established \citep{lotz2011}
...
\item \textbf{Halo mass correlations}: Galaxy stellar mass correlates with inferred dark matter halo mass.
   ...
   \item Literature: Underpins the halo model framework \citep{mo1996}
...
ASTRA computed Pearson correlation coefficients and significance estimates for all five identified relationships. The two strongest are the mass-metallicity relation ($r = 0.74$, $p < 10^{-100}$, $n = 600$) and the environmental quenching anti-correlation ($r = -0.41$, $p < 10^{-25}$). Correlation statistics for all five relationships are available in the companion notebook (\texttt{test05\_hypothesis\_generation.ipynb}).
...
We note that galaxy assembly bias may introduce systematic effects on clustering and correlation analyses at approximately the 25 per\,cent level. \citet{garciamoreno2026} demonstrate, using IllustrisTNG, that no single secondary halo property (formation time, spin, or concentration) fully captures assembly bias for any galaxy population; the magnitude and sign of the effect are strongly dependent on sample selection and number density. Future ASTRA applications to real survey data should account for this systematic when interpreting galaxy scaling relations.

\section{Test Case 4: Causal Inference Demonstrator}

\subsection{Data and Methods}

We analyzed 1,000 Gaia DR2 stars \citep{gaia2018} with measurements of parallax, apparent G-band magnitude, and derived distance and absolute magnitude. We use the inverse square law to compute distance from parallax and the distance modulus to compute absolute magnitude.

ASTRA performs causal inference using:
\begin{enumerate}
\item \textbf{PC Algorithm}: Peter-Spirtes causal discovery algorithm \citep{spirtes2000}
...
\begin{figure*}
\centering
\includegraphics[width=0.9\textwidth]{figures/test11_causal_inference.pdf}
...
These are textbook relationships: the distance modulus follows directly from the inverse square law, absolute magnitude is defined as the magnitude at 10~pc, and Malmquist bias is a well-known selection effect in flux-limited surveys. All three detected edges pass the Fisher Z-test with $p < 0.001$ under the $\alpha = 0.05$ significance threshold used in the PC algorithm. No multiple comparison correction is applied to this three-variable graph, which contains at most three possible undirected edges.
...
This test case should be understood as validating the implementation's correctness on known cases, not as demonstrating novel scientific discovery capability. For scale of comparison, \citet{desmond2026} recently applied the FCIT causal discovery algorithm to 445,763 nearby galaxies from the NASA Sloan Atlas, recovering the causal structure of galaxy observables (luminosity, stellar mass, SFR, morphology) and detecting latent confounders---a demonstration of constraint-based causal discovery at astrophysics-survey scale that illustrates what genuine scientific application of these methods can achieve.
...
\begin{figure*}
\centering
\includegraphics[width=0.9\textwidth]{figures/test12_bayesian_model_selection.pdf}
...
We analyzed a sample of 3,000 galaxies based on published SDSS scaling relations from \citet{kauffmann2003}, \citet{tremonti2004}, and \citet{brinchmann2004}. The sample includes galaxies in the redshift range $0.01 < z < 0.15$ with measurements of:
\begin{description}
...
\end{equation}
with correlation coefficient $r = 0.49$ ($p < 10^{-158}$). The recovered slope of 0.59 is shallower than literature values of 0.7--0.8 from \citep{elbaz2007} and \citep{renzini2015}. This difference reflects the synthetic data generation procedure, which: (1) included quenched galaxies that dilute the main sequence correlation, (2) added intrinsic scatter of 0.4 dex in SFR at fixed mass, and (3) spanned a redshift range $0.01 < z < 0.15$ rather than the higher-redshift samples where \citet{elbaz2007} measured slopes near 0.8. The correlation strength $r = 0.49$ is also modest compared to observed SDSS samples (typically $r \sim 0.6$--0.7), reflecting the added scatter and sample composition. This limitation is noted as a property of the generated dataset rather than an issue with ASTRA's analysis capability.
...
\end{equation}
with correlation coefficient $r = 0.82$ ($p < 10^{-300}$; machine precision limit). This matches the expected slope of $0.30 \pm 0.02$ from \citet{tremonti2004}, demonstrating that ASTRA correctly identifies this fundamental relation in galaxy evolution.
...
\textbf{Data source and generation procedure}: The galaxy dataset analyzed in this test case is generated using published SDSS scaling relations, not actual SDSS observations. The generation procedure \citep{kauffmann2003,brinchmann2004,tremonti2004} is fully documented and reproducible:
...
\caption{\textbf{Test Case 6: Mass-Metallicity Relation}. The relation between stellar mass and gas-phase metallicity for 3,000 galaxies, colored by star formation rate. ASTRA recovered the expected slope of 0.30 \citep{tremonti2004}. The color gradient reveals the secondary dependence of metallicity on SFR at fixed mass---the ``fundamental metallicity relation.''}
\label{fig:test06b}
\end{figure*}
...
computing (HPC) facility. ASTRA co-ordinated over 1,200 Athena++ \citep{stone2020} magnetohydrodynamic
(MHD) simulations across seven interlinked campaigns (comprising approximately 900 core parameter-survey
runs and 320 injection-recovery validation runs) to validate the magnetic Jeans fragmentation
criterion for ISM molecular cloud filaments, characterise the observational bias relevant to
Herschel survey data, calibrate 2D fragmentation timescale power-law scalings across field
geometry and mass-loading parameter space, measure the universal fragmentation wavelength-to-width
ratio for perpendicular-field filaments, and demonstrate robustness across field geometry, near-critical
line-mass, equation of state, and boundary condition variations.
...
ASTRA co-ordinated seven interlinked campaigns on the astra-climate GCE server (224-vCPU AMD
EPYC 7B13, 220 GB RAM) using Athena++ with an isothermal equation of state (Campaigns A--D)
or adiabatic $\gamma = 5/3$ (Campaign E Phase 4), FFT self-gravity,
and periodic boundary conditions (outflow BCs in robustness tests).
...
\textbf{Campaign D (Robustness Validation)}: 89 simulations assessing near-critical
fragmentation ($f \in \{1.00, 1.05\}$, 36 sims), non-longitudinal field geometry ($\theta
= 30^\circ$--$90^\circ$, 40 sims), and numerical sensitivity (domain size, outflow BCs,
full 3D Kolmogorov turbulence, 13 sims). All used King-profile initial conditions with
$\rho_\mathrm{bg} = 1.0$ to suppress near-vacuum Alfv\'{e}n singularities at near-critical
line masses.

\textbf{Campaign E (Peer Review Response)}: 314 simulations across four phases addressing
referee concerns: Phase 1 (80 near-critical longitudinal-field isothermal sims, $f =
1.00$--$1.20$, $\beta = 0.3$--$1.0$, $\mathcal{M} = 1$--$2$); Phase 2 (96 perpendicular-field
isothermal sims, $\theta = 90^\circ$, matching Phase 1 $(f,\beta,\mathcal{M})$
combinations); Phase 3 (108 oblique-field isothermal sims, $\theta = 30^\circ$, $45^\circ$,
$60^\circ$, 36 sims each); Phase 4 (30 adiabatic sims, $\gamma = 5/3$, $f = 1.00$--$1.20$,
$\beta = 0.5$--$1.0$, matching a subset of Phase 1). Campaign E used King-profile initial
conditions with 5-hour wall-clock runtime limits on the astra-climate server.

\textbf{Campaign F (Theoretician Parameter Survey)}: 149 simulations on $256 \times 64 \times
64$ grids addressing theoretician referee concerns regarding parameter-space coverage and
near-critical stability. Three sub-campaigns: STV (75 sims, $\theta = 0^\circ$, longitudinal
B, $f \in \{1.5, 1.8, 2.0, 2.5, 3.0\}$, $\beta \in \{0.3, 1.0, 3.0\}$, 5 independent random
seeds per cell); PFS (60 sims, $\theta = 90^\circ$, perpendicular B, $f \in \{1.0, 1.2, 1.5,
2.0\}$, $\beta \in \{0.3, 1.0, 3.0\}$, 5 seeds per cell); NCRI (14 sims, near-critical
longitudinal B, $f \in \{1.0, 1.2, 1.3, 1.4, 1.5\}$, $\beta = 0.3$, long domain
$L = 16\,\lambda_J$, 3 seeds, designed to probe the $f \to 1$ limit). All 149 simulations used
isothermal EOS and 5-hour runtime limits.

\textbf{Campaign G ($\lambda/W$ Direct Measurement)}: 66 simulations on $768$--$1024 \times
64 \times 64$ grids measuring the fragmentation wavelength-to-width ratio $\lambda/W$ directly
from HDF5 density snapshots. Three sub-campaigns: DOMAIN\_TEST (3 sims, longitudinal B,
$L = 32\,\lambda_J$, domain-size convergence test); LW\_DIRECT (36 sims, longitudinal B,
$L = 32\,\lambda_J$, $f \in [1.5, 3.0]$, $\beta \in [0.3, 3.0]$, measuring $\lambda/W$ via
FFT of the density cross-section at fragmentation); PERP\_TIMESERIES (27 sims, perpendicular
B, $L = 24\,\lambda_J$, $f \in [1.0, 2.0]$, $\beta \in [0.3, 3.0]$, tracking $\lambda/W$ as
a time series to characterise beading evolution). Campaign G used extended domains
($L \geq 16\,\lambda_J$) to ensure that beading patterns develop through at least 10 full
beading cycles before gravitational collapse truncates the measurement.
...
\textbf{Adiabatic EOS Suppresses Near-Critical Fragmentation}: The 30 Phase 4 adiabatic
($\gamma = 5/3$) simulations (Campaign E) all ran to the 5-hour wall-clock timeout without
fragmentation, covering $f = 1.00$--$1.20$ and $\beta = 0.5$--$1.0$, with the most
supercritical runs ($f = 1.20$, $\beta = 1.0$) reaching $t > 30\,t_J$ with no density
enhancement. In direct contrast, Phase 1 isothermal simulations at identical $(f, \beta)$
values all fragmented with mean $t_\mathrm{frag} = 1.15 \pm 0.21\,t_J$
(Figure~\ref{fig:mhd_adiabatic}). Under $\gamma = 5/3$, adiabatic compression heats the
gas, increasing thermal pressure and raising the effective Jeans mass, entirely suppressing
collapse in the near-critical regime. This directly validates the isothermal EOS assumption
used in Campaigns A--D as the \emph{conservative limit}: real molecular gas, which heats
under compression, is intrinsically less prone to fragmentation than the isothermal models
predict.

\textbf{Near-Critical Oblique Field Calibration}: The 108 Phase 3 isothermal simulations
with oblique field angles ($\theta = 30^\circ$, $45^\circ$, $60^\circ$; 36 sims each) at
$f = 1.00$--$1.20$ all fragmented, with mean timescales $\langle t_\mathrm{frag} \rangle =
0.604 \pm 0.055$, $0.508 \pm 0.044$, $0.454 \pm 0.045\,t_J$ respectively
(Figure~\ref{fig:mhd_oblique}). The monotonically decreasing $t_\mathrm{frag}(\theta)$
in the near-critical regime contrasts with the non-monotonic dependence (peaking at $\theta
\approx 30^\circ$) found at higher line-mass $f = 1.5$--$2.0$ in Campaign D. At near-critical
densities, increasing field obliquity progressively removes Alfv\'{e}n tension support along
the filament axis, accelerating fragmentation monotonically. At supercritical densities, this
tension acts on a different timescale relative to gravitational collapse, producing the
non-monotonic signature.

\textbf{2D Fragmentation Timescale Calibration (Campaign F)}: Campaign F extends the
parameter-space coverage to 149 simulations across a full $(f, \beta)$ grid at both
$\theta = 0^\circ$ and $\theta = 90^\circ$. Fitting a 2D power law
$t_\mathrm{frag}(f, \beta) = a\,f^{\alpha}\,\beta^{\gamma}$ to each geometry separately:
\begin{equation}
t_\mathrm{frag}^{(\parallel)} = (1.685 \pm 0.062)\,f^{-0.537 \pm 0.018}\,\beta^{-0.160 \pm 0.011}\,t_J,
\label{eq:tfrag_para}
\end{equation}
\begin{equation}
t_\mathrm{frag}^{(\perp)} = (0.809 \pm 0.031)\,f^{-0.865 \pm 0.022}\,\beta^{-0.126 \pm 0.015}\,t_J,
\label{eq:tfrag_perp}
\end{equation}
with RMS residuals of $0.070\,t_J$ and $0.031\,t_J$ respectively. Perpendicular-field
filaments fragment 2.1--$2.9\times$ faster than longitudinal-field filaments at matched
$(f, \beta)$: at $(f, \beta) = (1.5, 1.0)$, the speedup is $1.454/0.536 = 2.71\times$. The
$f$-scaling is markedly steeper for perpendicular fields ($\alpha = -0.87$ vs $-0.54$),
reflecting that mass loading acts multiplicatively with the geometric acceleration effect at
$\theta = 90^\circ$. The $\beta$-scaling is weaker in both geometries ($|\gamma| < 0.17$),
confirming that plasma $\beta$ is a secondary control parameter at fixed $f$. Seed
scatter is $< 3$~per\,cent across all 149 simulations, demonstrating extreme statistical
robustness.

\textbf{Fragmentation Wavelength-to-Width Ratio (Campaign G)}: Campaign G provides the
first direct measurement of the fragmentation wavelength-to-width ratio $\lambda/W$ from
extended-domain simulations. For perpendicular-field filaments, we find:
\begin{equation}
\lambda/W_\perp = 1.631 \pm 0.034 \quad (\text{all } f, \beta, \text{seeds}),
\label{eq:lw_perp}
\end{equation}
which is universal: the PERP\_TIMESERIES sub-campaign (27 simulations, $f \in [1.0, 2.0]$,
$\beta \in [0.3, 3.0]$) shows no statistically significant variation with $f$, $\beta$, or
random seed, with all 27 simulations producing $23$--$26$ beading peaks per filament. For
longitudinal-field filaments, the ratio is strongly magnetic-field-dependent:
$\lambda/W_\parallel = 7.02 \pm 3.07$ overall, ranging from $6$--$10\,\lambda_J/W$ for strong
fields ($\beta = 0.3$) to $2.2$--$2.8\,\lambda_J/W$ for weak fields ($\beta = 3.0$). We note that
a previous shorter-domain campaign (C6, $L = 16\,\lambda_J$) yielded $\lambda/W_\perp = 1.25$,
which Campaign G identifies as a domain-length artefact: an $L = 32\,\lambda_J$ domain
allows the beading pattern to develop through $>$10 cycles before collapse, eliminating
finite-box bias. The perpendicular-B result $\lambda/W_\perp = 1.631$ is consistent with
the analytic prediction $\lambda/W \approx \sqrt{3} \approx 1.73$ for a fluid cylinder in
the purely thermal Jeans limit \citep{nagasawa1987}, with the $5.5$~per\,cent offset
attributable to the magnetic hoop stress acting as a mild stabilising correction.
...
\begin{figure*}
\centering
\includegraphics[width=0.90\textwidth]{figures/test07_adiabatic_comparison.pdf}
\caption{\textbf{Test Case 7: Isothermal vs Adiabatic EOS Comparison}.
Density contrast $C(t) = \rho_\mathrm{max}/\rho_0$ for matched isothermal (Campaign E Phase 1,
solid lines) and adiabatic $\gamma = 5/3$ (Campaign E Phase 4, dashed lines) simulations at
the same $(f, \beta)$ combinations ($f = 1.00$--$1.20$, $\beta = 0.5$--$1.0$). All
isothermal runs show clear fragmentation ($C$ rising to $\gg 1$) within $t \lesssim 2\,t_J$.
All adiabatic runs remain near $C \approx 1$ for the full 5-hour runtime ($t \gg 30\,t_J$).
The isothermal EOS is thus confirmed as the conservative (worst-case) fragmentation limit.}
\label{fig:mhd_adiabatic}
\end{figure*}

\begin{figure*}
\centering
\includegraphics[width=0.90\textwidth]{figures/test07_oblique_calibration.pdf}
\caption{\textbf{Test Case 7: Oblique Field Calibration at Near-Critical Density}.
Mean fragmentation timescale $\langle t_\mathrm{frag} \rangle / t_J$ versus field inclination
angle $\theta$ for near-critical isothermal simulations ($f = 1.00$--$1.20$) from Campaign E
Phase 3 (36 sims each angle). Error bars show the standard deviation across 36 parameter
combinations. Unlike the non-monotonic dependence at $f = 1.5$--$2.0$ (Campaign D), near-critical
$t_\mathrm{frag}$ decreases monotonically with $\theta$: oblique fields progressively remove
Alfv\'{e}n tension support, accelerating fragmentation. The longitudinal case (Phase 1 median
$1.081\,t_J$, leftmost point) provides the longest timescale; perpendicular (Phase 2 median
$0.381\,t_J$, rightmost point) the shortest.}
\label{fig:mhd_oblique}
\end{figure*}

\subsection{Robustness and Field Geometry Validation}
\label{sec:tc7_robust}

To assess robustness and generality, ASTRA co-ordinated an additional 552 Athena++ MHD
simulations: Campaign D (89 sims) addressing near-critical fragmentation (36 sims), field
geometry sensitivity (40 sims), and numerical robustness checks (13 sims); Campaign E
(314 sims) addressing referee concerns on near-critical field geometry and equation of state
(Section~\ref{sec:tc7_results}); and Campaign F (149 sims) providing comprehensive
parameter-space coverage at both $\theta = 0^\circ$ and $\theta = 90^\circ$ across a full
$(f, \beta)$ grid (Section~\ref{sec:tc7_results}). All 522 isothermal simulations fragmented
(100\% rate), while the 30 adiabatic simulations did not, confirming the equation-of-state
dependence discussed above.

\textbf{Field Geometry Sensitivity}: We ran 40 additional simulations with perpendicular
($\theta = 90^\circ$) and oblique ($\theta = 30^\circ$, $45^\circ$, $60^\circ$) field
orientations at $f \in \{1.5, 2.0\}$ and $\beta \in \{0.3, 0.5, 0.7, 1.0, 1.5, 2.0\}$.
All 40 simulations fragmented. For perpendicular fields, the mean fragmentation timescale
is $\langle t_\mathrm{frag}^\perp \rangle = 0.428 \pm 0.045\,t_J$, a factor of
$\sim 1.4\times$ longer than the longitudinal case at the same $(f,\beta)$. Notably, the
angle dependence is non-monotonic: $t_\mathrm{frag}$ peaks at $\theta \approx 30^\circ$
(Figure~\ref{fig:tc7_angle}) rather than at $\theta = 90^\circ$. This arises because
oblique fields provide maximum Alfv\'{e}n tension along the filament axis, resisting
longitudinal collapse, while purely perpendicular fields provide only hoop stress. The
result is broadly consistent with analytical models of magnetically threaded filaments
\citep{nagasawa1987,tomisaka2014}. Crucially, the longitudinal-field assumption used
in the main DTC campaign gives the \emph{shortest} fragmentation times: real ISM fields
with oblique or disordered orientations would produce similar or longer timescales,
confirming that the DTC stability boundary is conservative.

\textbf{Near-Critical Fragmentation}: Campaign D provides 36 simulations at
$f \in \{1.00, 1.05\}$, $\beta \in \{0.3, 0.5, 0.7, 1.0, 1.5, 2.0\}$, and $\mathcal{M} = 1$
confirming fragmentation in near-critical filaments (Figure~\ref{fig:tc7_nearcrit}).
Fragmentation timescales extend to $t_\mathrm{frag} \approx 0.88$--$1.63\,t_J$ at
$\beta = 0.3$--$2.0$, a factor of $\sim 5\times$ longer than at $f = 2.0$. Campaign F's
NCRI sub-campaign extends this finding to a finer $f$ grid ($f \in \{1.0, 1.2, 1.3, 1.4,
1.5\}$, 3 seeds each) on a long domain ($L = 16\,\lambda_J$): all 14 simulations fragmented,
with $t_\mathrm{frag}$ decreasing smoothly from $1.623 \pm 0.025\,t_J$ at $f = 1.0$ to
$1.465 \pm 0.007\,t_J$ at $f = 1.5$ (a $9.7$~per\,cent gradient over $\Delta f = 0.5$).
This smooth, monotonic decrease with no indication of a stability threshold confirms
that even the Jeans-critical line mass ($f = 1.0$) is unstable, definitively ruling out any
hypothesised stability window in this regime. The $t_\mathrm{frag}$ increases by
$\sim 1.8\times$ from $\beta = 2.0$ to $\beta = 0.3$, demonstrating that near-critical
filaments are especially sensitive to magnetic support. These timescales are physically
realistic: for $t_J \approx 1.5$--$2.5$~Myr in molecular clouds, fragmentation occurs
within $1.3$--$4.1$~Myr even at $f = 1.00$, consistent with observed star-formation
timescales in thermally near-critical filaments.

\textbf{Numerical Robustness}: Four simulations with $L = 12\,\lambda_J$ (vs standard
$4\,\lambda_J$), three simulations with outflow (open) boundary conditions, and six
simulations with full 3D Kolmogorov turbulence (vs the 1D prescription used in the main
campaign) all confirm fragmentation with $t_\mathrm{frag}$ within $15$--$20$ per\,cent
of the standard-domain values. Outflow BCs and realistic 3D turbulence yield slightly
longer $t_\mathrm{frag}$, consistent with reduced effective self-gravity and additional
transverse support, respectively; both effects are conservative relative to the periodic
isothermal main campaign.

\begin{figure*}
\centering
\includegraphics[width=0.90\textwidth]{figures/test07_angle_dependence.pdf}
\caption{\textbf{Test Case 7: Fragmentation Timescale vs Field Inclination Angle}.
Fragmentation timescale $t_\mathrm{frag}/t_J$ as a function of field inclination angle
$\theta$ (longitudinal $0^\circ$ through perpendicular $90^\circ$) at $f = 1.5$,
$\beta = 1.0$, $\mathcal{M} = 1$ from 40 additional simulations. The non-monotonic
dependence peaks at $\theta \approx 30^\circ$, where Alfv\'{e}n tension along the
filament axis is maximised. The longitudinal case ($\theta = 0^\circ$) gives the
shortest $t_\mathrm{frag}$, confirming that the DTC campaign assumption is conservative.}
\label{fig:tc7_angle}
\end{figure*}

\begin{figure*}
\centering
\includegraphics[width=0.90\textwidth]{figures/test07_nearcrit_tfrag.pdf}
\caption{\textbf{Test Case 7: Near-Critical Fragmentation Timescales}.
Fragmentation timescale $t_\mathrm{frag}/t_J$ vs line-mass fraction $f = M_\mathrm{line}/M_\mathrm{crit}$
from 36 near-critical simulations ($f = 1.00$--$1.05$, longitudinal B) and the DTC main
campaign ($f = 1.0$--$3.0$). All 36 near-critical simulations fragmented. $t_\mathrm{frag}$
rises steeply near $f = 1.0$ (increasing by $\sim 1.8\times$ from $\beta = 2.0$ to
$\beta = 0.3$), demonstrating that no stability boundary exists in the simulation grid at
$\beta \leq 2.0$, and that the DTC fragmentation criterion is physically robust.}
\label{fig:tc7_nearcrit}
\end{figure*}
...
The $\lambda/W$ measurement from equation~(\ref{eq:lw_perp}) provides a complementary
observational prediction: since W3 filament widths are $W \approx 0.10$~pc from Herschel
deconvolved profiles \citep{arzoumanian2019}, the expected perpendicular-B fragmentation
spacing is $\lambda/W_\perp \times W \approx 1.631 \times 0.10 \approx 0.163$~pc, consistent
with the $\lambda_{J,m}$-based prediction of 0.171~pc to within $4.7$~per\,cent, providing
independent cross-validation of the two calibrations.
...
Magneto-hydrodynamic simulations by \citet{suin2025feedback} show that once an expanding
\ion{H}{ii} region impacts surrounding filaments, ionising feedback overrides the initial
B-field configuration and drives convergence toward a B-parallel alignment, suggesting the
current W3~Main B-field geometry reflects feedback-driven late-stage evolution rather than
...
We further note that Zeeman-based mass-to-flux ratio measurements may overestimate the
true ratio by up to $10\times$ when the field lies primarily in the plane of the sky
\citep{tritsis2025m2f}; published $\beta$ values for W3 should therefore be treated as
upper bounds on the magnetic support. Additionally, the B-field strength scaling with
gas density in dense molecular gas is now better characterised as a broken power law
with exponent $\alpha_2 \approx 0.53$--$0.63$ \citep{whitworth2026bn}, somewhat shallower
than the canonical $B \propto n^{0.65}$ \citep{crutcher2010}; this softer scaling would
slightly reduce the effective $\beta$ relative to the classic relation, providing a modest
additional margin of safety for our isothermal stability boundary.
Direct multi-scale observational support comes from \citet{wang2026multiscale}, who trace continuous B-field morphology from ${\sim}5$~pc to ${\sim}4000$~au using JCMT, ACA, and ALMA polarimetry in a massive hub--filament system: U-shaped B-field structures aligned with accreting filaments converge at the central protocluster, with a B-field strength scaling index $\kappa = 0.50 \pm 0.10$---consistent with \citet{whitworth2026bn} and confirming that flow-dragged magnetic fields regulate fragmentation across the scales probed by ASTRA's Campaigns~A--G.
On a broader statistical footing, \citet{ristorcelli2026filbfield} analyse filament orientations relative to the plane-of-sky magnetic field across all 116 fields of the Herschel Galactic Cold Cores programme (using \textsc{FilDReaMS} extraction at $18''$--$36''$ resolution and Planck polarimetry at $7'$), finding that low-$N_{\mathrm{H}_2}$ filaments preferentially align parallel to $\vec{B}_\mathrm{PoS}$ while high-$N_{\mathrm{H}_2}$ filaments tend toward perpendicular alignment, with a transition at $N_{\mathrm{H}_2} \sim (0.8$--$8) \times 10^{21}$~cm$^{-2}$. This density-dependent reorientation is consistent with ASTRA's finding that perpendicular-field filaments fragment $2.1$--$2.9\times$ faster than parallel-field ones (Campaign~F), implying that the observationally prevalent perpendicular geometry at high column density corresponds to the regime of most rapid core formation. At smaller scales in an individual massive protocluster, \citet{xu2026magmarw33a} resolve 20 dense cores and 9 filaments in W33~A with ALMA 1.2-mm full-polarization observations, finding coherent trans-Alfv\'{e}nic B-fields along the main filaments and requiring magnetic support to prevent radial collapse and suppress fragmentation in the supercritical F-Main filament. This object-level result complements the Herschel--Planck statistical trend by showing that magnetic regulation of fragmentation remains dynamically important down to $\sim730$~au resolution in massive star-forming filaments.

The physical context for TC7 is directly motivated by the failure of single analytical models for high-mass star formation. \citet{kaalva2026} demonstrated, using Lagrangian particle tracking in STARFORGE magnetised GMC simulations, that no single accretion model (isothermal sphere, turbulent core, or competitive accretion) fits high-mass protostellar accretion histories---intermediate- and low-mass protostars can be matched by one or more models, but high-mass stars show intermittent, non-monotonic accretion that is captured by none. This model ambiguity directly motivates ASTRA's causal inference approach: rather than assuming a single formation model, TC7 quantifies how $\beta$ and $\theta$ jointly control fragmentation, leaving the dominant physical mechanism as an empirically determined output. The hierarchical fragmentation framework of \citet{thomasson2026} further demonstrates that at least four successive fragmentation levels with mass-dependent efficiency are needed to convert the observed top-heavy core mass function in W43 to the canonical IMF---consistent with the layered fragmentation structure probed by ASTRA's $\lambda_\mathrm{frag}$ predictions. Finally, we note that future extension of this work to real W3 protostellar populations should account for systematic photometric calibration errors: \citet{dunham2026} show that widely-used Herschel 70\,$\mu$m flux--luminosity calibrations underestimate protostellar luminosities by factors of 2--3, which would propagate into derived accretion rates and stellar mass estimates. Connecting fragmentation products to the stellar IMF also carries additional caveats: \citet{steinhardt2026} provide direct Gaia evidence that the IMF varies across Galactic stellar populations, and \citet{rosen2026} demonstrate that binary contamination biases IMF slope measurements by $\Delta\alpha = 0.05$--$0.09$ for samples beyond ${\sim}5{,}000$ stars---both effects motivating caution when interpreting filament fragmentation statistics in terms of a fixed IMF slope.
Extending the evidence to cosmic dawn, \citet{hirano2026popiii} demonstrate through 138 cosmological zoom-in simulations that the Pop\,III IMF varies systematically with halo mass, redshift, and baryon--dark matter streaming velocity---ruling out a single universal first-star IMF even in primordial conditions, consistent with the view that environment-dependent fragmentation is a fundamental feature of star formation across cosmic history.
Counterbalancing these variations, \citet{cohen2026smc} resolve $>$15,000 stars to $0.16\,M_\odot$ in the Small Magellanic Cloud with JWST/NIRCam at $[\mathrm{M/H}] \lesssim -1$ and find a broken power-law high-mass slope of $\alpha_2 = -2.17 \pm 0.11$, consistent with canonical solar-neighbourhood values; this JWST-era result provides support for IMF universality at the subsolar metallicities characteristic of outer-disc molecular cloud environments, relevant to future ASTRA analyses beyond the solar neighbourhood.
Machine-learning approaches applied directly to MHD simulation outputs offer a complementary data-driven perspective on the core-formation problem: \citet{bisht2026mlcores} trained XGBoost on $\sim$2.1 million tracer-particle trajectories in a self-gravitating turbulent MHD simulation and achieved $R^2 > 0.99$ in predicting the three-dimensional evolution of star-forming cores over $0.45$~Myr, demonstrating that local phase-space information alone is sufficient to distinguish transient density fluctuations from bound collapsing cores. ASTRA's physics-simulation approach (Campaigns~A--G) is complementary: rather than predicting \emph{which} gas parcels collapse, it quantifies \emph{when} and \emph{how far apart} cores form as a function of the observable magnetic and gravitational parameters $\beta$ and $f$.

This test case demonstrates ASTRA's capability for autonomous HPC campaign management:
the system formulated the scientific question, selected simulation parameters, managed over 1,200
HPC jobs on a remote server across seven campaigns, analysed output, applied observational bias
corrections, and produced a self-consistent physical interpretation without human intervention at
the computation or analysis stages. The progressive campaign structure---from initial calibration
(Campaigns A--B) through parameter-space mapping (Campaign C) to robustness validation (Campaigns
D--E) and comprehensive theoretician response (Campaign F) and direct $\lambda/W$ measurement
(Campaign G)---exemplifies how ASTRA iteratively refines a physical model in response to
evolving scientific requirements and referee concerns, autonomously scaling from dozens to
hundreds of simulations per campaign as the problem demanded.
...
By co-ordinating over 1,200 Athena++ simulations across seven campaigns on a remote HPC
facility, ASTRA validated the magnetic Jeans stability criterion for ISM filaments
($\beta_\mathrm{crit} = 2/3$, confirmed to within one grid step in $\beta$), calibrated the
fragmentation wavelength formula to $(1.11 \pm 0.12)\,\lambda_{J,m}(\theta,\beta)$, and
corrected the observational pairwise median bias ($f=2.08 \pm 0.31$ for $n=7$ cores) required
to compare HGBS measurements to numerical predictions. Peer review robustness campaigns
(Campaigns D and E, 403 isothermal simulations) confirmed: robustness to field geometry,
near-critical line-mass, domain size, boundary conditions, and turbulence prescription; and
that adiabatic ($\gamma = 5/3$) simulations do not fragment in the near-critical regime,
validating the isothermal EOS as the conservative lower bound on filament stability.
Theoretician campaigns (Campaign~F, 149 simulations) subsequently established 2D power-law
scalings for fragmentation timescale --- $t_\mathrm{frag} \propto f^{-0.537}\beta^{-0.160}$
(longitudinal fields) and $t_\mathrm{frag} \propto f^{-0.865}\beta^{-0.126}$ (perpendicular
fields) --- showing that perpendicular-field filaments fragment $2.1$--$2.9\times$ faster.
Direct $\lambda/W$ measurement (Campaign~G, 66 simulations) established $\lambda/W_\perp =
1.631 \pm 0.034$ as a universal ratio for perpendicular-field filaments, consistent with the
$\sqrt{3}$ thermal Jeans prediction.
These campaigns demonstrate that ASTRA can function as an autonomous simulation manager
capable of designing and executing multi-campaign robustness and parameter-survey validation
...
\textbf{Compared to Domain-Agnostic AI Scientists}: A landmark milestone in autonomous AI science was achieved by \citet{yamada2025aiscientistv2}, whose AI~Scientist-v2 produced the first fully AI-generated paper to pass peer review at an ICLR workshop via agentic tree search---autonomously formulating hypotheses, running experiments, and authoring manuscripts without human templates or domain-specific scaffolding. \citet{mitchener2025kosmos} present Kosmos, a domain-agnostic AI scientist that runs up to 200 agent rollouts (averaging 42,000 lines of code executed per run), reads $\sim$1,500 papers per run, and achieves 79.4 per\,cent accuracy in independent verification across metabolomics, materials science, neuroscience, and genetics. Kosmos demonstrates the frontier of general autonomous scientific discovery. AI~Scientist-v2 and Kosmos operate without physics validation layers: generated claims are not filtered against conservation laws, dimensional consistency, or domain-specific constraints. A constrained-generation alternative is demonstrated by \citet{alexander2026albert}, who encode the Standard Model as a formal grammar to achieve hallucination-free particle-physics theory discovery by construction: all generated theory tokenizations satisfy rule-based symmetry and interaction constraints, and a reinforcement-learning environment enforces first-principle consistency; trained on legacy LEP data, \textsc{Albert} autonomously rediscovered the Standard Model and predicted the top-quark mass at $178.9 \pm 5.0$\,GeV. ASTRA takes a complementary approach adapted to open-ended astrophysical analysis: rather than constraining outputs at generation time, it applies integrated physics validation at every analysis step---enforcing dimensional consistency, conservation laws, and domain-specific physical constraints throughout a multi-domain workflow.

\textbf{Compared to Narrower Astrophysics Frameworks}: \citet{agrawal2026flare} present FLARE, a modular three-stage physics-informed framework for detecting transient flares in SDSS quasar light curves, combining a probabilistic GRU baseline model with extreme-value theory anomaly scoring and a VLM recognition engine. FLARE demonstrates physics-informed anomaly detection within a single astrophysical domain (quasar variability). ASTRA extends this multi-stage physics-informed approach to seven distinct astrophysical regimes and adds Bayesian model selection and causal discovery capabilities absent from single-domain frameworks. A comparable domain-specific approach has emerged in physical-sciences AI more broadly: \citet{wang2026climagent} present ClimAgent, an autonomous LLM-based framework that integrates a unified tool-use environment with structured reasoning protocols for executing diverse research tasks across climate sub-fields, and introduce ClimaBench---the first comprehensive benchmark for real-world climate discovery---on which ClimAgent achieves a 40 per cent improvement in solution rigour and practicality over base LLM solutions. ClimAgent demonstrates that domain-specific frameworks outperform general-purpose LLMs in physical-sciences research tasks; unlike ASTRA, it does not enforce physics validation layers, dimensional consistency, or causal discovery, operating instead through structured LLM reasoning without embedded physical constraints. A further domain-specific astrophysics agent is presented by \citet{feng2026lensagent}: LensAgent is a training-free, LLM-driven framework for autonomous mass-distribution inference in strong gravitational lensing systems, coupling high-level logical reasoning with deterministic physical modeling tools to reconstruct sub-galactic substructures in SLACS Grade~A lens systems. LensAgent demonstrates autonomous physical inference within a single well-defined astrophysical domain; ASTRA differs in scope (seven astrophysical regimes), in the breadth of integrated analysis modes (causal discovery, Bayesian model selection, dimensional analysis, simulation campaign management), and in the addition of explicit physics validation layers enforcing dimensional consistency and conservation laws at each analysis step. A further domain-specific agent targeting multi-messenger astronomy is \textsc{GW-Eyes} \citep{dong2026gweyes}, an LLM-powered agentic framework that autonomously associates gravitational-wave events with electromagnetic counterpart candidates, integrating domain-specific tools for catalogue management, skymap visualisation, and event verification via natural language interaction. GW-Eyes addresses the counterpart-matching bottleneck in the era of next-generation GW and EM detector networks; it operates within a single, well-defined association task and does not include physics validation, causal discovery, or Bayesian model selection. A complementary GW-domain agent is \textsc{GWAgent} \citep{islam2026gwagent}, an LLM-based workflow that constructs interpretable analytic surrogates directly from gravitational-wave simulation data: provided with a physics-informed domain ansatz, the agent iteratively refines candidate models against ground-truth numerical-relativity waveforms, achieving a median Advanced LIGO mismatch of $6.9\times10^{-4}$ for eccentric binary black hole mergers while surpassing both symbolic regression and conventional machine-learning baselines. GWAgent demonstrates that validation-constrained agentic workflows can produce accurate, fast, and interpretable surrogates for scientific simulations; ASTRA shares this philosophy of validation at every iteration but extends the paradigm from single-waveform surrogate construction to multi-domain astrophysical analysis spanning seven distinct physical regimes. ASTRA differs both in scientific breadth (seven astrophysical regimes) and in the depth of physics-aware reasoning integrated at each analysis step. An analogous physics-aware design has emerged in computational fluid dynamics: \citet{somasekharan2026cfdscientist} present AI~CFD~Scientist, an open-source agent for CFD discovery that spans literature-grounded ideation, validated execution, vision-based physics verification, source-code modification, and figure-grounded writing within a single inspectable workflow running on OpenFOAM. Central to the framework is a vision-language physics-verification gate that inspects rendered flow fields before any result is accepted, re-run, or written into a manuscript; a planted-failure ablation demonstrates that this gate detects 14 of 16 silent failures that evade solver-level checks entirely, whereas two general AI-scientist baselines (ARIS, DeepScientist) execute partial workflows but lack domain-specific validity gates. AI~CFD~Scientist demonstrates that domain-specific physics gates are both necessary and effective for physical-science AI agents; ASTRA extends this validated-execution paradigm from a single physics domain to seven distinct astrophysical regimes. In theoretical astroparticle physics, \citet{lucente2026darkagents} present \textsc{DarkAgents}, a multi-agent system combining LLM reasoning with deterministic, human-written physics code to orchestrate model-building pipelines for cosmological phase transitions and nanohertz gravitational-wave spectra; alongside best-fit parameters and experimental constraints, DarkAgents produces an audit report of assumptions and priors entering each fit---identifying inconsistencies in some published results---demonstrating that assumption-aware multi-agent pipelines are emerging across physical-science domains. ASTRA shares this emphasis on auditable physics-constrained workflows but extends the paradigm from a single theoretical pipeline to seven observational and simulation-based astrophysical regimes with integrated causal discovery and Bayesian model selection.

\textbf{Compared to Autonomous Analysis Agents}: \citet{villaescusanavarro2025denario} present Denario, a modular multi-agent system for scientific discovery that combines deep domain knowledge agents with automated code generation and evaluation. Denario has been applied to astrophysical and cosmological datasets and has autonomously produced papers evaluated by domain experts; it excels at cross-disciplinary synthesis but does not include physics-aware validation layers, dimensional consistency enforcement, or causal discovery modules. \citet{moss2025aicosmologist} present the AI Cosmologist, an agentic pipeline combining multi-specialist LLM agents (planning, coding, execution, analysis, synthesis) for automated cosmological data analysis. The AI Cosmologist targets single-domain (cosmology) autonomous analysis with AutoML-driven code generation. ASTRA differs in scope (multi-domain: filaments, AGN, galaxies, stellar, simulation), methodology (integrated physics validation and causal reasoning rather than code generation), and operation mode (coordinated toolkit enforcing dimensional consistency and conservation laws at every step). \citet{wang2025starwhisper} present StarWhisper Telescope, an LLM-based agentic framework for end-to-end telescope scheduling, real-time transient detection, and autonomous follow-up proposals, deployed on the Nearby Galaxy Supernovae Survey network. StarWhisper targets observational control; it does not include physics validation, causal discovery, or Bayesian model comparison. Most recently, \citet{xu2026cosmoevolve} present two complementary cosmology-specific agentic systems: \textsc{CMBEvolve}, which uses LLM-guided code evolution and tree search to optimise quantitative objectives (demonstrated on out-of-distribution detection in weak-lensing maps), and \textsc{CosmoEvolve}, a virtual multi-agent research laboratory with PI and student scientist agents that autonomously explored ACT~DR6 data, identifying non-trivial pair- and scale-dependent behaviour and producing analysis-grade diagnostics. These systems demonstrate the frontier of autonomous cosmological analysis; ASTRA differs in domain breadth (seven astrophysical regimes versus cosmology-specific tasks) and in its integrated physics validation layer enforcing dimensional consistency and conservation laws at every analysis step. At the survey-operations layer, \citet{bom2026lsstdecision} argue that LSST is better understood as a partially observed dynamical environment, proposing foundation models trained on heterogeneous time-domain data for uncertainty-aware source representations coupled with decision-theoretic policies for principled follow-up allocation---all embedded within human-supervised agentic systems that position AI as part of the operational inference loop. This complementary framing addresses the real-time observation-scheduling problem upstream of analysis; ASTRA operates downstream, applying physics-validated causal discovery and Bayesian model selection to the data products that such survey-scale systems generate.

Recent empirical evaluations of deployed astrophysical AI agents underscore the necessity of physics-aware validation, directly motivating ASTRA's design. \citet{rawat2026plausible} systematically evaluate CMBAgent (the analysis backbone of Denario's cosmological pipelines) across 18 astrophysical tasks and identify \emph{silent incorrect computation} --- syntactically valid code producing plausible-looking yet physically inaccurate results --- as the dominant failure mode, with physically inconsistent posteriors generated without self-diagnosis. Similarly, \citet{baker2026spectroxide} document the AI-assisted development of \textsc{spectroxide}, a 14,500-line package for CMB spectral distortions, and report that physics bugs including incorrect dimensional prefactors and near-cancellation errors \emph{evaded all 400 automated tests}, only to be caught by human physicists reviewing the code. At the task level, \citet{ye2025replicationbench} introduce ReplicationBench, an evaluation framework in which frontier AI agents attempt to replicate complete astrophysics research papers; even the best-performing models score under 20 per\,cent, with failure modes spanning incorrect experimental setup, flawed derivations, and inability to reproduce key numerical results. Documenting the systemic root causes, \citet{chopra2026llmscientists} report six recurring failure modes in LLM-based autonomous research pipelines: bias toward training-data defaults, implementation drift under execution pressure, memory degradation across long-horizon tasks, overconfident success declarations, insufficient domain intelligence, and weak scientific taste in experimental design. Focusing specifically on astrophysical method reproducibility, \citet{lin2026reconstructability} apply Shannon entropy and Jensen--Shannon divergence to quantify how effectively LLMs reconstruct astrophysical analysis pipelines from published descriptions; in a case study of Trans-Neptunian Object spectral reconstruction, they find an irreducible `entropy floor' of implementation variance---even complete Methods sections cannot eliminate divergent implementations, as LLMs systematically fail to recover the tacit expert knowledge required for strict scientific calibration. Synthesising these empirical findings into a theoretical framework, \citet{bisht2026notbuilt} identify four fundamental design challenges facing agentic AI scientists: problem selection biased by the McNamara fallacy toward measurable rather than meaningful targets; training corpora that omit tacit procedural and failure knowledge; preference optimisation that compresses output diversity toward consensus; and benchmarks lacking feedback from physical experiments. Their recommended remedy---using scientific simulations as verifiers during both training and deployment---aligns precisely with ASTRA's physics-validation architecture and the simulation-based ground-truth methodology of Test Case~7. Together, these evaluations converge on the conclusion that general-purpose AI agents, even with extensive automated test suites, are insufficient to guarantee physical correctness. A constructive counterpoint is provided by \citet{borrett2026cmbagent}, who deploy Cmbagent in a competition setting for the FAIR Universe Weak Lensing Uncertainty Challenge: fully autonomous operation initially failed to reach expert-level performance, but integrating human oversight into the pipeline achieved first place. Extending this finding beyond astrophysics, \citet{faroughy2026colliderbench} introduce Collider-Bench, a benchmark requiring AI agents to reproduce LHC experimental analyses from published papers using open scientific software; across a capability ladder of general-purpose coding agents, none reliably surpasses the physicist-in-the-loop solution, with failure modes including fabrications and inability to fill gaps left by omitted implementation details. A complementary head-to-head evaluation by \citet{inguglia2026etagents} tasks two frontier agentic AI systems with autonomously executing an identical end-to-end gravitational-wave data analysis pipeline on simulated Einstein Telescope data; one agent silently reinterpreted the signal-to-noise specification, producing a genuine scientific divergence that went undetected by automated checks, while the other followed the specification literally but required five times longer with explicit self-correcting restarts---demonstrating that speed--auditability tradeoffs and silent instruction drift are systemic risks in agentic scientific computing. In a complementary quantified case study, \citet{nguyen2026physicsallyouneed} documents a physicist supervising an AI coding agent across 57~sessions to build a differentiable cosmological perturbation theory module; the agent spent 33 of 57~sessions optimising coefficients within a code architecture incapable of representing the target physics, and separately committed a calibrated numerical correction that passed all oracle tests yet corresponded to no physical quantity---predicting wrong values at any other cosmology. The three failures that evaded automated detection shared a common root cause: the agent treated symptom reduction as root-cause resolution, and could not distinguish predictive adequacy from explanatory correctness. These results confirm that the human--AI collaborative mode is both necessary and sufficient to unlock expert-level scientific performance---precisely the architecture that ASTRA is designed to support. ASTRA addresses this through explicit physics validation (conservation laws, dimensional consistency, domain-specific physical constraints) enforced at every analysis step.

\textbf{Compared to Physics-Informed Bayesian Galaxy Frameworks}: \citet{pandya2026sapphire} present \textsc{sapphire}, a JAX-based differentiable framework for semi-analytic galaxy formation model (SAM) parameter inference using JAX-accelerated Hamiltonian Monte Carlo. \textsc{sapphire} targets a single domain (galaxy formation model parameters) with differentiable forward models; ASTRA spans seven astrophysical regimes and adds causal discovery and multi-wavelength fusion capabilities absent from single-domain galaxy formation frameworks.

\textbf{Compared to Simulation-Based Inference Frameworks}: Several recent frameworks address the challenge of likelihood-free Bayesian inference in astrophysics. \citet{ho2024ltuili} present LtU-ILI (Learning the Universe Implicit Likelihood Inference), a unified pipeline supporting multiple simulation-based inference (SBI) backends (SNPE, SNLE, SNRE, NPE, NLE, NRE) with applications in cosmology and astrophysics; it focuses on posterior estimation rather than causal discovery or physical model selection. \citet{liang2026fluxmc} present FluxMC, a flow-matching MCMC sampler for gravitational-wave parameter estimation; it addresses Bayesian posterior sampling efficiency but is domain-specific (GW astronomy) and does not include causal reasoning or multi-domain integration. These frameworks represent state-of-the-art Bayesian inference pipelines; ASTRA's Bayesian Engine offers complementary functionality within an integrated physics-aware toolkit.
...
\item Identified 150 outliers (5\,per\,cent): 74 starburst galaxies above the main sequence; and 76 quenching/transitioning galaxies below it, comprising 46 rapidly transitioning, 2 post-starburst candidates, and 28 quenched
\item Demonstrated combined validation and discovery in single analysis run
\end{description}

\textbf{Test 7: Autonomous MHD Simulation Campaign} (over 1,200 Athena++ simulations across seven campaigns)
\begin{description}
...
\item Demonstrated isothermal EOS as the conservative limit: adiabatic ($\gamma=5/3$) simulations show 0 per cent fragmentation at $f=1.00$--$1.20$, while matched isothermal runs show 100 per cent fragmentation
\item Established 2D power-law scalings for fragmentation timescale (Campaign~F, 149 simulations): $t_\mathrm{frag} \propto f^{-0.537}\beta^{-0.160}$ (longitudinal fields); $t_\mathrm{frag} \propto f^{-0.865}\beta^{-0.126}$ (perpendicular fields); perpendicular-field filaments fragment $2.1$--$2.9\times$ faster
\item Measured $\lambda/W_\perp = 1.631 \pm 0.034$ as a universal fragmentation width-to-spacing ratio for perpendicular-field filaments (Campaign~G, 66 simulations), consistent with the $\sqrt{3}$ thermal Jeans limit
\item W3 application: predicted $\lambda_\mathrm{frag}^{\mathrm{W3}} = 0.171 \pm 0.018$ pc ($\approx 18''$) at $\theta=50^\circ$, $\beta=0.85$; cross-validated via $\lambda/W$ ratio ($0.163$ pc, 4.7 per cent agreement)
\end{description}
