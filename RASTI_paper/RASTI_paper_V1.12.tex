...
(MHD) simulations across seven interlinked campaigns to validate the magnetic Jeans fragmentation
...
$(f, \beta)$ grid (Section~\ref{sec:tc7_results}). All 552 isothermal simulations fragmented
