...
ASTRA\footnote{Note: NASA operates a separate astrophysics programme also named ASTRA \citep{caputo2026nasa}. This paper describes a distinct AI-driven autonomous research system for astrophysical data analysis.} addresses this challenge by providing an integrated framework that combines:
\begin{description}
...
\textbf{Compared to Physics-Informed Bayesian Galaxy Frameworks}: \citet{pandya2026sapphire} present \textsc{sapphire}, a JAX-based differentiable framework combining physics-informed galaxy formation models with simulation-based inference for stellar population SED fitting. \textsc{sapphire} targets a single domain (galaxy SEDs) with differentiable forward models; ASTRA spans seven astrophysical regimes and adds causal discovery and multi-wavelength fusion capabilities absent from single-domain SED frameworks.
