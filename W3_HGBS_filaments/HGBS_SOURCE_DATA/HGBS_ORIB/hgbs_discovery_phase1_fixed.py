...
# FITS files
FITS_FILES = {
    '70_micron': os.path.join(HGBS_DIR, 'HGBS_OrionB_070.fits'),
    '160_micron': os.path.join(HGBS_DIR, 'HGBS_OrionB_160.fits'),
    '250_micron': os.path.join(HGBS_DIR, 'HGBS_OrionB_250.fits'),
    '350_micron': os.path.join(HGBS_DIR, 'HGBS_OrionB_350.fits'),
    '500_micron': os.path.join(HGBS_DIR, 'HGBS_OrionB_500.fits'),
...
def main():
    ...
    try:
        # Import the OrionB catalog parser
