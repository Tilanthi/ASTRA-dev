...
FITS_FILES = {
    ...
    'dust_temperature': os.path.join(HGBS_DIR, 'HGBS_taurus_L1495_dust_temperature_map.fits'),  # Using hires for temp
    'column_density_hires': os.path.join(HGBS_DIR, 'HGBS_taurus_L1495_dust_temperature_map.fits'),
