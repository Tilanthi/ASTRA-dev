...
# DATA PATHS
# ============================================================================
HGBS_DIR = '/Users/gjw255/astrodata/SWARM/ASTRA/HGBS_TMC1'
PERSISTENCE_THRESHOLD = 20

# FITS files
COL_DEN_FILE = os.path.join(HGBS_DIR, 'HGBS_taurusTMC1_hires_column_density_map.fits')
TEMP_FILE = os.path.join(HGBS_DIR, 'HGBS_taurusTMC1_dust_temperature_map.fits')
SKELETON_FILE = os.path.join(HGBS_DIR, 'HGBS_taurusTMC1_skeleton_map_thresh20.fits')
