...
# FITS files
COL_DEN_FILE = os.path.join(HGBS_DIR, 'HGBS_aquilaM2_column_density_map.fits')
TEMP_FILE = os.path.join(HGBS_DIR, 'HGBS_aquilaM2_dust_temperature_map.fits')
SKELETON_FILE = os.path.join(HGBS_DIR, 'HGBS_aquilaM2_skeleton_map.fits')

# Catalog file
CAT_FILE = os.path.join(HGBS_DIR, 'HGBS_aquilaM2_derived_core_catalog.txt')
...
class CoreFilamentAnalyzer:
    ...
    def parse_catalog(self):
        ...
        self.cores = parse_hgbs_catalog(CAT_FILE)
...
def main():
    ...
    # Save results
    output_file = '/Users/gjw255/astrodata/SWARM/ASTRA/HGBS/phase2_results.npz'
