...
# FITS files
COL_DEN_FILE = os.path.join(HGBS_DIR, 'HGBS_aquilaM2_hires_column_density_map.fits')
TEMP_FILE = os.path.join(HGBS_DIR, 'HGBS_aquilaM2_dust_temperature_map.fits')
SKELETON_FILE = os.path.join(HGBS_DIR, 'HGBS_aquilaM2_skeleton_map_thresh50.fits')
