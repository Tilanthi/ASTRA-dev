...
# DATA PATHS
# ============================================================================
HGBS_DIR = '/Users/gjw255/astrodata/SWARM/ASTRA/HGBS_CRA'
PERSISTENCE_THRESHOLD = 30

# FITS files
COL_DEN_FILE = os.path.join(HGBS_DIR, 'HGBS_craNS_hires_column_density_map.fits')
TEMP_FILE = os.path.join(HGBS_DIR, 'HGBS_craNS_dust_temperature_map.fits')
SKELETON_FILE = os.path.join(HGBS_DIR, 'HGBS_craNS_skeleton_map_thresh30.fits')
