#!/usr/bin/env python3
"""
HGBS Taurus Discovery Science - Phase 2: Core-Filament Association
...
# Catalog file
CAT_FILE = os.path.join(HGBS_DIR, 'core_catalog_ic5146.csv')
...
class CoreFilamentAnalyzer:
    ...
    def parse_catalog(self):
        ...
        self.cores = parse_ic5146_catalog(CAT_FILE)
    ...
    def convert_coordinates(self):
        ...
        for core in self.cores:
            try:
                ...
                print(f"  Warning: Coordinate conversion failed for {core.get('name', 'unknown')}: {e}")
                continue
    ...
    def calculate_filament_distances(self):
        ...
        for core in self.cores_with_coords:
            ...
            try:
                ...
                # At 260 pc distance
                dist_pc = 140 * np.tan(np.deg2rad(pix_size_deg * 3600)) * dist
    ...
    def _pixels_to_pc(self, pixel_dist):
        ...
        try:
            ...
            dist_pc = 140 * pix_size_rad * pixel_dist
            return dist_pc
        except:
    ...
    def run_analysis(self):
        ...
        print("\n" + "="*70)
        print("HGBS IC5146 - PHASE 2: CORE-FILAMENT ASSOCIATION")
        print("="*70)
