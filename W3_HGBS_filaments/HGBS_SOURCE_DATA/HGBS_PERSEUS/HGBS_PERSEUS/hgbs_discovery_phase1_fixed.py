#!/usr/bin/env python3
"""
HGBS Perseus Discovery Science - Phase 1: Data Exploration and Characterization

This script performs initial data exploration of the Herschel Gould Belt Survey
Perseus region data, including:
...
# FITS files
FITS_FILES = {
    '70_micron': os.path.join(HGBS_DIR, 'HGBS_Perseus_070.fits'),
    '160_micron': os.path.join(HGBS_DIR, 'HGBS_Perseus_160.fits'),
    '250_micron': os.path.join(HGBS_DIR, 'HGBS_Perseus_250.fits'),
    '350_micron': os.path.join(HGBS_DIR, 'HGBS_Perseus_350.fits'),
    '500_micron': os.path.join(HGBS_DIR, 'HGBS_Perseus_500.fits'),
    'column_density': os.path.join(HGBS_DIR, 'HGBS_perseus_hires_column_density_map.fits'),
    'dust_temperature': os.path.join(HGBS_DIR, 'HGBS_perseus_hires_column_density_map.fits'),  # Using hires for temp
    'column_density_hires': os.path.join(HGBS_DIR, 'HGBS_perseus_hires_column_density_map.fits'),
    'skeleton': os.path.join(HGBS_DIR, 'HGBS_perseus_skeleton_map.fits'),
}

# Catalog files
CAT_FILES = {
    'derived': os.path.join(HGBS_DIR, 'HGBS_perseus_derived_core_catalog.txt'),
    'observed': os.path.join(HGBS_DIR, 'HGBS_perseus_observed_core_catalog.txt'),
}
...
def main():
    ...
    try:
        # Import the Perseus catalog parser
        import parse_perseus_catalog
        cores = parse_perseus_catalog.parse_perseus_catalog(CAT_FILES['derived'])
