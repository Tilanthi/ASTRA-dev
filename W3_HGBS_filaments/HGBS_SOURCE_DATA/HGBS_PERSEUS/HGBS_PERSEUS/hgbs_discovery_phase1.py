...
FITS_FILES = {
    ...
    'column_density': os.path.join(HGBS_DIR, 'HGBS_perseus_column_density_map.fits'),
    'dust_temperature': os.path.join(HGBS_DIR, 'HGBS_perseus_dust_temperature_map.fits'),
...
def main():
    ...
    print("\n" + "="*70)
    print("HGBS PERSEUS - DISCOVERY SCIENCE PHASE 1")
