#!/usr/bin/env python3
"""
HGBS Perseus Discovery Science - Phase 5: Discovery Mode with ASTRA

This script applies ASTRA's discovery capabilities to the HGBS Perseus data:
...
class ASTRADiscoveryEngine:
    ...
    def detect_anomalies(self):
        ...
        alphas = np.array([c.get('alpha_be', np.nan) for c in self.cores])
    ...
    def run_discovery_mode(self):
        ...
        print("\n" + "="*70)
        print("HGBS PERSEUS - PHASE 5: DISCOVERY MODE WITH ASTRA")
        print("="*70)
