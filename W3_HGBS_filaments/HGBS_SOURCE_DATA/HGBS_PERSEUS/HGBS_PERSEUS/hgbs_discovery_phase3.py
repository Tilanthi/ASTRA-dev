#!/usr/bin/env python3
"""
HGBS Perseus Discovery Science - Phase 3: Mass-per-unit-Length Analysis
...
# DATA PATHS
# ============================================================================
HGBS_DIR = '/Users/gjw255/astrodata/SWARM/ASTRA/HGBS_PERSEUS/HGBS_PERSEUS'; HGBS_PARENT = '/Users/gjw255/astrodata/SWARM/ASTRA/HGBS_PERSEUS'
...
# Physical constants
DISTANCE_PC = 230.0  # Distance to Perseus (pc)
...
class MLineAnalyzer:
    ...
    def load_cores(self):
        ...
        try:
            ...
            self.cores = parse_perseus_catalog(os.path.join(HGBS_DIR, 'HGBS_perseus_derived_core_catalog.txt'))
    ...
    def run_analysis(self):
        ...
        print("\n" + "="*70)
        print("HGBS PERSEUS - PHASE 3: MASS-PER-UNIT-LENGTH ANALYSIS")
        print("="*70)
