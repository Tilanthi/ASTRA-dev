#!/usr/bin/env python3
"""
HGBS Aquila Discovery Science - Phase 2: Core-Filament Association
...
# DATA PATHS
# ============================================================================
HGBS_DIR = '/Users/gjw255/astrodata/SWARM/ASTRA/HGBS_PERSEUS'
PERSISTENCE_THRESHOLD = 45

# FITS files
COL_DEN_FILE = os.path.join(HGBS_DIR, 'HGBS_orionB_column_density_map.fits')
TEMP_FILE = os.path.join(HGBS_DIR, 'HGBS_orionB_hires_column_density_map.fits')
SKELETON_FILE = os.path.join(HGBS_DIR, 'HGBS_perseus_skeleton_map_thresh45.fits')

# Catalog file
CAT_FILE = os.path.join(HGBS_DIR, 'HGBS_orionB_derived_core_catalog.txt')
...
class CoreFilamentAnalyzer:
    ...
    def parse_catalog(self):
        ...
        self.cores = parse_orionb_catalog(CAT_FILE)
    ...
    def calculate_filament_distances(self):
        ...
        # Create boolean mask of filament pixels (persistence >= 50)
        ...
        for core in self.cores_with_coords:
            ...
            try:
                ...
                # At 260 pc distance
                dist_pc = 260 * np.tan(np.deg2rad(pix_size_deg * 3600)) * dist
    ...
    def extract_local_properties(self):
        ...
        print(f"  Median local T: {np.median([c['local_temp'] for c in self.cores_with_coords]):.2f} K")
    ...
    def _pixels_to_pc(self, pixel_dist):
        ...
        try:
            ...
            dist_pc = 260 * pix_size_rad * pixel_dist
            return dist_pc
        except:
    ...
    def run_analysis(self):
        ...
        print("\n" + "="*70)
        print("HGBS AQUILA - PHASE 2: CORE-FILAMENT ASSOCIATION")
        print("="*70)
