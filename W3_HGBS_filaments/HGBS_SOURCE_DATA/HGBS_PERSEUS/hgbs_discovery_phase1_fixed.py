...
FITS_FILES = {
    ...
    'column_density': os.path.join(HGBS_DIR, 'HGBS_orionB_column_density_map.fits'),
    'dust_temperature': os.path.join(HGBS_DIR, 'HGBS_orionB_hires_column_density_map.fits'),  # Using hires for temp
    'column_density_hires': os.path.join(HGBS_DIR, 'HGBS_orionB_hires_column_density_map.fits'),
