#!/usr/bin/env python3
"""
HGBS Pipe Discovery Science - Phase 2: Core-Filament Association
...
SKELETON_FILE = os.path.join(HGBS_DIR, 'HGBS_pipe_skeleton_map.fits')

# Catalog file
CAT_FILE = os.path.join(HGBS_DIR, 'core_catalog_pipe_derived.csv')
...
class CoreFilamentAnalyzer:
    ...
    def __init__(self):
        ...
        print("Initializing HGBS Core-Filament Analyzer for Pipe...")
    ...
    def parse_catalog(self):
        ...
        from parse_pipe_catalog import parse_pipe_catalog
        self.cores = parse_pipe_catalog(CAT_FILE)
    ...
    def run_analysis(self):
        ...
        print("\n" + "="*70)
        print("HGBS Pipe - PHASE 2: CORE-FILAMENT ASSOCIATION")
        print("="*70)
