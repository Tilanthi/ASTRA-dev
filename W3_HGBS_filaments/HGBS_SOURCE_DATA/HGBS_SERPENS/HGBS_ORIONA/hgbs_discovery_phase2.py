#!/usr/bin/env python3
"""
HGBS Orion A Discovery Science - Phase 2: Core-Filament Association
...
# DATA PATHS
# ============================================================================
HGBS_DIR = '/Users/gjw255/astrodata/SWARM/ASTRA/HGBS_SERPENS/HGBS_ORIONA'

# FITS files
COL_DEN_FILE = os.path.join(HGBS_DIR, 'HGBS_oriona_column_density_map.fits')
TEMP_FILE = os.path.join(HGBS_DIR, 'HGBS_oriona_dust_temperature_map.fits')
SKELETON_FILE = os.path.join(HGBS_DIR, 'HGBS_oriona_skeleton_map.fits')

# Catalog file
CAT_FILE = os.path.join(HGBS_DIR, 'core_catalog_oriona_derived.csv')
...
class CoreFilamentAnalyzer:
    ...
    def __init__(self):
        ...
        print("Initializing HGBS Core-Filament Analyzer for Orion A...")
    ...
    def parse_catalog(self):
        ...
        from parse_oriona_catalog import parse_oriona_catalog
        self.cores = parse_oriona_catalog(CAT_FILE)
    ...
    def calculate_filament_distances(self):
        ...
        for core in self.cores_with_coords:
            ...
            try:
                ...
                # At 420 pc distance
                dist_pc = 420 * np.tan(np.deg2rad(pix_size_deg * 3600)) * dist
    ...
    def _pixels_to_pc(self, pixel_dist):
        """Convert pixel distance to parsecs at 420 pc."""
        try:
            ...
            # Distance to cloud (420 pc)
            dist_pc = 420 * pix_size_rad * pixel_dist
            return dist_pc
        except:
    ...
    def run_analysis(self):
        ...
        print("\n" + "="*70)
        print("HGBS Orion A - PHASE 2: CORE-FILAMENT ASSOCIATION")
        print("="*70)
