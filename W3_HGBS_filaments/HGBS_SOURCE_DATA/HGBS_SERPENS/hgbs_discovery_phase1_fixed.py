...
# FITS files
FITS_FILES = {
    '70_micron': os.path.join(HGBS_DIR, 'HGBS_Serpens_070.fits'),
    '160_micron': os.path.join(HGBS_DIR, 'HGBS_Serpens_160.fits'),
    '250_micron': os.path.join(HGBS_DIR, 'HGBS_Serpens_250.fits'),
    '350_micron': os.path.join(HGBS_DIR, 'HGBS_Serpens_350.fits'),
    '500_micron': os.path.join(HGBS_DIR, 'HGBS_Serpens_500.fits'),
    'column_density': os.path.join(HGBS_DIR, 'HGBS_serpens_hires_column_density_map.fits'),
    'dust_temperature': os.path.join(HGBS_DIR, 'HGBS_serpens_dust_temperature_map.fits'),  # Using hires for temp
    'column_density_hires': os.path.join(HGBS_DIR, 'HGBS_serpens_dust_temperature_map.fits'),
...
def main():
    ...
    try:
        # Import the Serpens catalog parser
