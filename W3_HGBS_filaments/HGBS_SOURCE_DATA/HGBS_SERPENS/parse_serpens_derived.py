#!/usr/bin/env python3
"""
Parse Serpens Derived Core Catalog (CSV Format)

The Serpens derived catalog is in CSV format with columns:
...
def parse_serpens_catalog(filename):
    """Parse the Serpens derived core catalog from CSV file."""
    cores = []
...
def parse_line(parts, line_num):
    """Parse a single line from the Serpens derived catalog."""
    try:
        ...
        core_name = f'SERPENS_{obj_id:04d}'
...
if __name__ == '__main__':
    catalog_file = '/Users/gjw255/astrodata/SWARM/ASTRA/HGBS_SERPENS/core_catalog_serpens_derived.csv'

    print("="*70)
    print("Parsing Serpens Derived Core Catalog")
    print("="*70)
