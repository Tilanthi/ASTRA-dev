...
class IntegratedCounterfactualSystem:
    ...
    def __init__(self):
        ...
        try:
            ...
            try:
                from stan_core.reasoning.counterfactual_reasoning import CounterfactualEngine
            except ImportError:
    ...
    def _process_counterfactual(self, query: str,
        ...
        try:
            # Try absolute import first
            try:
                from stan_core.reasoning.filament_counterfactual_simple import FilamentCounterfactualAnalyzer
            except ImportError:
                # Fall back to relative import
