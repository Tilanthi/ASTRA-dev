...
try:
    ...
    try:
        ...
        from stan_core.reasoning.v41_orchestrator import (
            V41Orchestrator, ReasoningMode, ReasoningTask, ReasoningResult
        )
        from stan_core.reasoning.integration_bus import (
            get_integration_bus, Event, EventType, EventPriority
        )
        from stan_core.core_legacy.v92.v92_system import V92CompleteSystem
        from stan_core.core_legacy.v50.v50_discovery_engine import V50DiscoveryEngine
        HAS_V41_V50_V92 = True
...
try:
    ...
    try:
        from stan_core.astro_physics.core import AstroSwarmSystem
        HAS_ASTROSWARM = True
    except ImportError as e:
...
try:
    ...
    try:
        from stan_core.swarm.client import MORKClient
        HAS_MORK = True
    except ImportError as e:
