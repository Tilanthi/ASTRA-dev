#!/usr/bin/env python3
"""
Test script to verify import fixes for stan_core modules.
...
# Add parent directory to path so stan_core can be imported
# We need STAN_IX_ASTRO in the path, not stan_core
...
def test_adaptive_reasoning_imports():
    ...
    from stan_core.scientific_discovery.adaptive_reasoning import (
...
def test_discovery_orchestrator_imports():
    ...
    from stan_core.scientific_discovery.discovery_orchestrator import (
