...
def test_enhanced_features():
    ...
    from stan_core.self_teaching.embedding_novelty import (
    ...
    from stan_core.self_teaching.scientific_data import (
        PhysicsDataLibrary,
    ...
    from stan_core.self_teaching.multi_agent_swarm import (
    ...
    # Agent breakdown
    from stan_core.self_teaching.multi_agent_swarm import AgentRole
    agent_counts = {}
    ...
    from stan_core.self_teaching.arxiv_integration import (
