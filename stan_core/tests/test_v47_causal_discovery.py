...
def test_module_interconnections():
    ...
    total_tests += 1
    try:
        from stan_core.causal.discovery.bayesian_structure_learning import BayesianStructureLearner, InferenceMethod
        from stan_core.causal.discovery.eig_calculator import create_eig_calculator
    ...
    total_tests += 1
    try:
        from stan_core.causal.discovery.online_causal_learning import OnlineCausalLearner
    ...
    total_tests += 1
    try:
        from stan_core.causal.inference import create_sbi_engine
        from stan_core.causal.discovery.eig_calculator import ObservationPlan, NoiseModel
    ...
    try:
        ...
        print("✓ All V47+ modules importable from stan_core.causal")
        success_count += 1
    except Exception as e:
