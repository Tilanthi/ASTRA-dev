...
Usage:
    python stan_core/tests/v4/run_tests.py              # Run all tests
    python stan_core/tests/v4/run_tests.py --mce        # Test MCE only
    python stan_core/tests/v4/run_tests.py --asc        # Test ASC only
    python stan_core/tests/v4/run_tests.py --crn        # Test CRN only
    python stan_core/tests/v4/run_tests.py --mmol       # Test MMOL only
    python stan_core/tests/v4/run_tests.py --integration # Test integration only
...
# Tests are in: stan_core/tests/v4/
# Project root is: ../ (from stan_core)
...
def run_integration_tests():
    ...
    try:
        from stan_core.v4_revolutionary import create_v4_coordinator, IntegrationMode
