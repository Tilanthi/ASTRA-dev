...
from stan_core.causal.routing import (
    MoECapabilityRouter,
...
def test_capability_imports(results: IntegrationTestResults):
    ...
    import_tests = [
        # Causal
        ("stan_core.causal.model.scm", "StructuralCausalModel"),
        ("stan_core.causal.discovery.pc_algorithm", "PCAlgorithm"),

        # Memory
        ("stan_core.memory.episodic.memory", "EpisodicMemory"),
        ("stan_core.memory.working.memory", "WorkingMemory"),
        ("stan_core.memory.semantic.memory", "SemanticMemory"),

        # Simulation
        ("stan_core.simulation.physics.simulator", "PhysicsSimulator"),

        # Metacognitive
        ("stan_core.metacognitive.monitoring", "CognitiveMonitor"),
    ]
...
def test_permissionless_hooks(results: IntegrationTestResults):
    ...
    try:
        from stan_core.causal.routing.moe_router import Expert
